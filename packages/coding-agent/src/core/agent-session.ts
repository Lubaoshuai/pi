...
export class AgentSession {
	...
	async reload(options?: { beforeSessionStart?: () => void | Promise<void> }): Promise<void> {
		// Reload invalidates the extension runner; a tool still executing would
		// access it after returning and turn its successful result into an
		// error. Match the TUI checks and reject instead.
		if (this.isStreaming) {
